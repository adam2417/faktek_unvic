	...
	<div id="page" align="center">
		...
		<div id="content">
			...
			<div id="contenttext">
				...
				<span class="subtitle_gray">Fakultas Teknik Universitas Victory Sorong</span><br />
				<br />
				<p class="body_text" align="justify">Aplikasi ini digunakan untuk memberikan informasi seputar
				Fakultas Teknik Universitas Victory Sorong seperti informasi mengenai pengumuman akademik,fakultas dan rektorat.
                Serta informasi di luar dari konteks yang sudah disebutkan sebelumnya.
				<br /><br />
			...
			<br />			
			<div class="footer">			
				Copyright@2017 By Admin.<br/>All Right Reserved. This application created only by special purpose.
			</div>
		</div>
	</div>
</body>
